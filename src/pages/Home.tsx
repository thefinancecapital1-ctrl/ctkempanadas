  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative h-[90vh] flex items-center justify-center overflow-hidden bg-grain">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-blur-in">
          <h1 className="text-5xl md:text-7xl font-heading font-extrabold text-white mb-6 drop-shadow-lg text-glow">
            Handcrafted Empanadas
          </h1>
          <p className="text-xl md:text-2xl text-white/95 mb-8 font-medium drop-shadow-md" style={{ animationDelay: "0.3s" }}>
            Bay Area Pop-Up & Markets
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center" style={{ animationDelay: "0.5s" }}>
